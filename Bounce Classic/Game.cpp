...
int main()
{
    ...
    ball.setPosition(rect_W * 2, rect_H + 45);
    sf::Texture ballT;
    ...
    ball.setFillColor(sf::Color(100, 200, 255));
    ...
    ballL.setFillColor(sf::Color(100, 255, 150, 70));
    ...
    WallArray.close();*/
    std::fstream CompArray;
    CompArray.open("Compare.txt", std::ios::out);
    ...
    WallReadArray.open("Wall_Arr2.txt", std::ios::in);
    if (!WallReadArray) {
        std::cout << "File doesn’t exist.";
    }
    std::fstream MoveReadArray;
    MoveReadArray.open("Move_Arr2.txt", std::ios::in);
    if (!MoveReadArray) {
        std::cout << "File doesn’t exist.";
    }
...
*/
    ...
    for (int i = 0; i < w; ++i)
    {
        ...
        for (int j = 0; j < h; ++j)
        {
          ...
          //  std::cout << Wall_Arr[102][0].getPosition().x << std::endl;
            CompArray << "Previous Wall_Arr[" << i << "][" << j << "] Position ; X = " << Wall_Arr[i][j].getPosition().x << " ; Y = " << Wall_Arr[i][j].getPosition().y << " ;       NEW ; ";
            ...
            if (Wall_Arr[i][j].getPosition().x == -200)
            {
                ...
                Wall_Arr[i][j].setPosition(Wall_Arr[i][j].getPosition().x + (74 * i) - rect_W/2, Wall_Arr[i][j].getPosition().y + (74 * j) + rect_W / 2 - 1260);
            CompArray << " Wall_Arr[" << i << "][" << j << "] Position ; X = " << Wall_Arr[i][j].getPosition().x << " ; Y = " << Wall_Arr[i][j].getPosition().y << std::endl;
            ...
            if (Move_Arr[i][j].getPosition().x == -200 || Move_Arr[i][j].getPosition().y > 450)
            {
                Move_Arr[i][j].setPosition(Move_Arr[i][j].getPosition().x - Move_Arr[i][j].getPosition().x - 10000, 0);
            }
            else
                Move_Arr[i][j].setPosition(Move_Arr[i][j].getPosition().x + (74 * i) - rect_W/2, Move_Arr[i][j].getPosition().y  + (74 * j)  - 1260);
            ...
            if (j == 20)
                std::cout << " ; Move[" << i << "][j" << j << "] = " << "[" << Move_Arr[i][j].getPosition().x << "][" << Move_Arr[i][j].getPosition().y << "]" << std::endl;
        }
    }
    ...
    while (Window.isOpen())
    {
        ...
        B_j = (22 - ((Wall_Arr[0][21].getPosition().y - ball.getPosition().y)) / rect_H);
       ...
       /* if (ball.getPosition().y <= 0)
        ...
        if (Wall_Arr[B_i + 1][B_j].getPosition().x > -5000 && Wall_Arr[B_i + 1][B_j].getPosition().y != 0 && Wall_Arr[B_i + 1][B_j].getPosition().y > 675)
        {
       ...
       // top right checker
        ...
        if (Wall_Arr[B_i][B_j+1].getPosition().x > -5000 )
        {
            /*if (B_i == 84 && B_j == 4)
            {
                ...
                {
                    col = true;
                    std::cout << " ; bottom collision : " << B_i << " ; " << B_j<< " ; " << Move_Arr[B_i][B_j].getPosition().y << " ; ";
                    ball.setPosition(ball.getPosition().x, Move_Arr[B_i][B_j].getPosition().y);
               ...
               /*     if (B_i == 84 && B_j == 4)
                    {
                        ...
                        {
                            col = true;
                            std::cout << " ; bottom collision : " << B_i << " ; " << B_j + 1 << " ; " << Move_Arr[B_i][B_j].getPosition().y << " ; ";
                            ball.setPosition(ball.getPosition().x, Move_Arr[B_i][B_j].getPosition().y);
                            ballSpeed.y = -ballSpeed.y * 0.25;
                            B_i = (102 - ((Wall_Arr[102][0].getPosition().x - ball.getPosition().x)) / rect_W);
                            B_j = (22 - ((Wall_Arr[0][21].getPosition().y - ball.getPosition().y)) / rect_H);
                ...
                for (int j = 0; j < h; j++)
                {
                    ...
                    if (Wall_Arr[i][j].getPosition().x > -rect_W  && Wall_Arr[i][j].getPosition().x < Width + rect_W)
                    {
                        ...
                        if (j == 7)
                        {
                            ...
                            grass1_Arr[i].setPosition(Wall_Arr[i][j].getPosition().x - 45, Wall_Arr[i][j].getPosition().y - 180);
